    ...
    <div className="container border-top">
        <div className="row pt-5 pb-4">
            <div className="col-sm-9 legal-text">
                <p>Get the latest news, tutorials, and more from MyAlerts. Follow us on:</p>
            </div>
        ...
        <p>MyAlerts and the MyAlerts logo are either registered trademarks or trademarks of MyAlerts in Canada, the United States, and/or other countries. All other trademarks are the property of their respective owners.</p>
        <p>
        &copy; 2023 
        MyAlerts. All rights reserved. </p>        
